// Modified Segmented Controller from Cupertino Widgets Package
...
const Radius _kThumbRadius = Radius.circular(9);
...
class CustomCupertinoSlidingSegmentedControl<T> extends StatefulWidget {
  ...
  @override
  State<CustomCupertinoSlidingSegmentedControl<T>> createState() =>
  ...
  Widget build(BuildContext context) {
    ...
    return UnconstrainedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius:
              const BorderRadius.all(Radius.circular(_kCornerRadius + 5)),
